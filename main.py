...
def sendEmail():
    try:
        if request.json['emailId'] is not None:
            ...
            contact_add = "hiralalppurohit@gmail.com"  ## the email id of the support team
            fromaddr = "crackjee2016.hp@gmail.com"   ## the email id from where we are going to send the mail
            ...
            body = "Thank you for showing interest in our courses.Our Aim is to provide high Quality Courses to make you job ready.You can find the course details in the attached document"
            ...
            # Authentication
            s.login(fromaddr,"Hira@1997") # give your password here
